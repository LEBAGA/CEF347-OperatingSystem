...
struct IDT_ENTRY idt[256]; //There are a total of 256 possible idt (interrupt descriptor table)enteries
extern unsigned int isr1; //compiler to implement compilation so
//that it knows that there will be a section named isr1 in an outside source file
unsigned int base;
